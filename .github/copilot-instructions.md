...
The following final line is a required repo-specific prompt suffix for prioritization context only; it does not override the audit-first classification, overlap checks, or non-canonical ownership guidance above.
